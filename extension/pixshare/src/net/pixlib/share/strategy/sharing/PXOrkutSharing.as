...
package net.pixlib.share.strategy.sharing
{
	...
	/**
	 * Shares informations on Orkut platform.
	 * 
	 * @example
	 * <listing>
	 * 
	 * var post : PXPostSharing = new PXPostSharing();
	 * post.platform = new PXOrkutSharing();
	 ...
	 */
	public class PXOrkutSharing extends PXAbstractSharingStrategy
	{
		/**
		 * Orkut service adress.
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 10
		 */
		public static var SERVICE_URL : String = "http://promote.orkut.com/preview";
		 ...
		 * @playerversion Flash 10
		 */
		public function PXOrkutSharing()
		{
			service = SERVICE_URL;
			formSize = FORM_SIZE;
		}
		...
		override protected function buildVariables(text : String, url : String, options : PXSharingOptions = null) : void
		{
			...
			apiVariables.tt = text;
			apiVariables.du = url;
			apiVariables.nt = "orkut.com";
			
			if(options && options.message) apiVariables.cn = options.message;
			if(options && options.thumbnail) apiVariables.tn = options.thumbnail;
		}
	}
}
