...
package net.pixlib.events
{
	 ...
	 */
	final public class PXNumberEvent extends PXBasicEvent
	{
		//--------------------------------------------------------------------
		// Public properties
		//--------------------------------------------------------------------
		...
		/**
		 * Numeric value carried with this event.
		 * 
		 * @langversion 3.0
		 * @playerversion Flash 10
		 */
		 ...
		 * @playerversion Flash 10
		 */
		public function PXNumberEvent( eventType : String, target : Object = null, num : Number = 0, bubbles : Boolean = false, cancelable : Boolean = false )
		{
		...
		{
			return new PXNumberEvent(type, target, value, bubbles, cancelable);
		}
	}
}